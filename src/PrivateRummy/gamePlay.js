...
const { rummyPrivatePushPlayerScoreToPlayerScoreBoard } = require('../common-function/cardFunction');
...
module.exports.invalidDeclare = async (table, client) => {
  try {
    ...
    // eslint-disable-next-line no-unused-vars
    await rummyPrivatePushPlayerScoreToPlayerScoreBoard(tb, playerDetails);
