    ...
    try {
        ...
        for (let i = 0; i < tbInfo.gameTracks.length; i++) {
            if (tbInfo.gameTracks[i].playerStatus == "win") {
                ...
                await walletActions.addUserWalletGame(tbInfo.gameTracks[i]._id, Number(winnerTrack.winningAmount), CONST.TRANSACTION_TYPE.WIN, "TeenPatti Win", "Teen Patti Private", tbInfo._id);
