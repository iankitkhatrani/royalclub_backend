    ...
    try {
        if (requestData.playerId !== '' && requestData.playerId !== null && requestData.playerId !== undefined) {
            ...
            if (requestData.tableId == '') {
                ...
                sendDirectEvent(client.id.toString(), CONST.T_PRIVATE_RECONNECT, response);
                return false;
            }
            ...
            if (tabInfo.gameState === CONST.ROUND_STARTED) {
                ...
                sendDirectEvent(client.id.toString(), CONST.T_PRIVATE_RECONNECT, responseRS);
                ...
                sendDirectEvent(client.id.toString(), CONST.T_PRIVATE_RECONNECT, responseRST);
                ...
                sendDirectEvent(client.id.toString(), CONST.T_PRIVATE_RECONNECT, responseRE);
            ...
            sendDirectEvent(client.id, CONST.T_PRIVATE_RECONNECT, response, {
                flag: false,
